...
Marrow provides SIMD-vectorized compute kernels for arithmetic, aggregation, and selection. All kernels are null-aware: the exact null handling behaviour depends on the operation.
